...
class AuthController < ApplicationController
  def via_steam_openid
    ...
    auth_request = consumer.begin_without_discovery(steam_oid_service, true, true)
    redirect_to auth_request.redirect_url('www.backlogtracker.com', 'localhost:3000/logon/success')
  end
